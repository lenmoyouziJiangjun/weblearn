(function(){
    ...
    var gulp = require('gulp'),
        ...
        swiper = {
            ...
            jsFiles: [
                ...
                'src/js/jsDom.js',
                'src/js/get-jsDom-lib.js',
                'src/js/jsDom-plugins.js',
                'src/js/wrap-end.js',
                'src/js/amd.js'
            ],
            jQueryFiles : [
    ...
    function addJSIndent (file, t, minusIndent) {
        ...
        if (filename === 'swiper-intro.js' || filename === 'swiper-intro-f7.js' || filename === 'swiper-outro.js' || filename === 'jsDom.js' || filename === 'get-jsDom-lib.js' || filename === 'get-jquery.js' || filename === 'jsDom-plugins.js' || filename === 'swiper-proto.js') addIndent = '    ';
        if (minusIndent) {
